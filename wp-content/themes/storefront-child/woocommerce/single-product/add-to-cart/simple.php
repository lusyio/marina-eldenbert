    ...
    <div class="row">
        <div class="col-lg-8 pr-lg-0 pr-unset col-12 br">
            <div class="add-to-cart-block__body">
                        ...
                        <?php
                            ...
                            if (!isBookBought($product->get_id()) && !in_array('draft', $tagsArray)):
                                ...
                                <button type="submit" name="add-to-cart"
                                    ...
                                    за <?php echo $product->get_price_html(); ?> <p>(только чтение на сайте)</p>
                                </button>
                            <?php endif;
                ...
                <p class="add-to-cart-block__support-link"><a href="mailto:support@marina-eldebert.com">support@marina-eldebert.com</a></p>
