...
<div class="row" id="customer_login">
    ...
    <div class="col-12 offset-0 col-lg-6 offset-lg-3">
        ...
        <form class="woocommerce-form woocommerce-form-login login" method="post">
            ...
            <div class="row">
                <div class="col">
                    <label class="login-label" for="username"><?php esc_html_e('Username or email address', 'woocommerce'); ?>
            ...
            <div class="row">
                <div class="col">
                    <label class="login-label" for="password"><?php esc_html_e('Password', 'woocommerce'); ?>&nbsp;<span
    ...
    <div class="col-12 offset-0 col-lg-6 offset-lg-3" id="registerBlock" style="display: none">
        ...
        <form method="post"
            ...
            <?php if ('no' === get_option('woocommerce_registration_generate_username')) : ?>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <label class="login-label" for="reg_username"><?php esc_html_e('Username', 'woocommerce'); ?>&nbsp;<span
                                    class="required">*</span></label>
                        <input type="text" class="login-input form-control" name="username"
            ...
            <div class="row">
                <div class="col">
                    <label class="login-label" for="reg_email"><?php esc_html_e('Email address', 'woocommerce'); ?>&nbsp;<span
                                class="required">*</span></label>
                    <input type="email" class="login-input form-control" name="email"
            ...
            <p class="already-registered">
                <a href="#" class="register-toggle toggle-form" data-target-form="login">Я уже зарегистрирован</a>
            </p>
